    ...
    this.face.checkVideo(17, this.camera).subscribe(
      ...
      this.serv.carnes(this.camera, l).subscribe(
        res => {
          ...
          for (const m of this.carnes.raw){
          ...
          if (this.carnes.donut.length !== 0){
            this.source2 = this.carnes.donut;

          const labels = [];
          for (let o of Object.keys(this.carnes.over)){
            o = o + ':00:00';
            ...
            this.optionsL = {
              ...
              this.options = {
                ...
                legend: {
                  orient: 'vertical',
                  left: 'left',
                  data: Object.keys(this.carnes.donut),
                  textStyle: {
